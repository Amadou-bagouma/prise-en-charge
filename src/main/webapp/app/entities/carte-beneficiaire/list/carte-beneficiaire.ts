...
export class CarteBeneficiaire {
  readonly carteBeneficiaires = signal<ICarteBeneficiaire[]>([]);
  ...
  readonly isLoading = this.carteBeneficiaireService.carteBeneficiairesResource.isLoading;
  ...
  constructor() {
    effect(() => {
      const headers = this.carteBeneficiaireService.carteBeneficiairesResource.headers();
      if (headers) {
        this.fillComponentAttributesFromResponseHeader(headers);
      }
    });
    effect(() => {
      this.carteBeneficiaires.set(this.fillComponentAttributesFromResponseBody([...this.carteBeneficiaireService.carteBeneficiaires()]));
    });
    effect(() => {
  ...
  protected queryBackend(): void {
    ...
    this.carteBeneficiaireService.carteBeneficiairesParams.set(queryObject);
  }
