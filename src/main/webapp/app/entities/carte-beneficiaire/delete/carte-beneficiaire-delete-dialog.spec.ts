...
import { CarteBeneficiaireDeleteDialog } from './carte-beneficiaire-delete-dialog';

describe('CarteBeneficiaire Management Delete Component', () => {
  let comp: CarteBeneficiaireDeleteDialog;
  let fixture: ComponentFixture<CarteBeneficiaireDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CarteBeneficiaireDeleteDialog);
