...
@Component({
  templateUrl: './etablissement-sante-delete-dialog.html',
  imports: [TranslateDirective, FormsModule, FontAwesomeModule, AlertError],
})
export class EtablissementSanteDeleteDialog {
  etablissementSante?: IEtablissementSante;
  ...
  confirmDelete(id: number): void {
    this.etablissementSanteService.delete(id).subscribe(() => {
