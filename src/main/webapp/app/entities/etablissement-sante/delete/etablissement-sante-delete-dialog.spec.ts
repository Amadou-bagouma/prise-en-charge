...
import { EtablissementSanteDeleteDialog } from './etablissement-sante-delete-dialog';

describe('EtablissementSante Management Delete Component', () => {
  let comp: EtablissementSanteDeleteDialog;
  let fixture: ComponentFixture<EtablissementSanteDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EtablissementSanteDeleteDialog);
