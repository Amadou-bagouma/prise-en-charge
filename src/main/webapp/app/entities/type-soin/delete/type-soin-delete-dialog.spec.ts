...
import { TypeSoinDeleteDialog } from './type-soin-delete-dialog';

describe('TypeSoin Management Delete Component', () => {
  let comp: TypeSoinDeleteDialog;
  let fixture: ComponentFixture<TypeSoinDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TypeSoinDeleteDialog);
