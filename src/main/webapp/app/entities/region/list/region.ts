...
export class Region {
  ...
  readonly isLoading = this.regionService.regionsResource.isLoading;
  ...
  constructor() {
    effect(() => {
      const headers = this.regionService.regionsResource.headers();
      if (headers) {
        this.fillComponentAttributesFromResponseHeader(headers);
      }
    });
    effect(() => {
      this.regions.set(this.fillComponentAttributesFromResponseBody([...this.regionService.regions()]));
    });
    effect(() => {
  ...
  protected fillComponentAttributesFromResponseBody(data: IRegion[]): IRegion[] {
    return data;
  }
  ...
  protected queryBackend(): void {
    ...
    this.regionService.regionsParams.set(queryObject);
  }
