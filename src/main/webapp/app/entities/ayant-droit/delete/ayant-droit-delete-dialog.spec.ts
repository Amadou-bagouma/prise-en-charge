...
import { AyantDroitDeleteDialog } from './ayant-droit-delete-dialog';

describe('AyantDroit Management Delete Component', () => {
  let comp: AyantDroitDeleteDialog;
  let fixture: ComponentFixture<AyantDroitDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AyantDroitDeleteDialog);
