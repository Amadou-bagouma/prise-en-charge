...
export class DemandePriseEnChargeService extends DemandePriseEnChargesService {
  ...
  /**
   * Nombre de demandes correspondant aux critères, sans charger les lignes : sert les effectifs
   * portés par chaque puce de la barre de filtres (une puce sans compteur oblige l'agent à cliquer
   * pour savoir s'il y a quelque chose derrière).
   */
