...
import { DemandePriseEnChargeDeleteDialog } from './demande-prise-en-charge-delete-dialog';

describe('DemandePriseEnCharge Management Delete Component', () => {
  let comp: DemandePriseEnChargeDeleteDialog;
  let fixture: ComponentFixture<DemandePriseEnChargeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DemandePriseEnChargeDeleteDialog);
