...
import { GestionDeleteDialog } from './gestion-delete-dialog';

describe('Gestion Management Delete Component', () => {
  let comp: GestionDeleteDialog;
  let fixture: ComponentFixture<GestionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(GestionDeleteDialog);
