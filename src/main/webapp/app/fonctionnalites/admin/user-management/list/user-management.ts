...
export class UserManagement {
  ...
  setActive(userManagement: IUserManagement, isActivated: boolean): void {
    ...
    Object.assign(modalRef.componentInstance, {
      titre: isActivated ? 'Activer le compte' : 'Désactiver le compte',
      message: isActivated
        ? `Le compte ${userManagement.login} pourra de nouveau se connecter à l'application.`
        : `Le compte ${userManagement.login} ne pourra plus se connecter. Ses demandes et son historique sont conservés.`,
      libelleConfirmer: isActivated ? 'Activer le compte' : 'Désactiver le compte',
      ton: isActivated ? 'primaire' : 'danger',
    });
    modalRef.closed
