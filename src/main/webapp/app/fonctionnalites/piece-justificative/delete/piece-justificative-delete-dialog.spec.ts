...
import { PieceJustificativeDeleteDialog } from './piece-justificative-delete-dialog';

describe('PieceJustificative Management Delete Component', () => {
  let comp: PieceJustificativeDeleteDialog;
  let fixture: ComponentFixture<PieceJustificativeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PieceJustificativeDeleteDialog);
